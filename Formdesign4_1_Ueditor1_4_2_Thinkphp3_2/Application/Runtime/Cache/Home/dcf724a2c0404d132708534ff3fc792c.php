...
<html>
 <head>
    ...
    <title>表单数据 Ueditor FormDesign Plugins -leipi.org</title>
...
<div class="row">
    <ol class="breadcrumb">
        ...
        <li class="active">表单数据 [<?php echo ($form_one["form_name"]); ?>]</li>
    </ol>
</div>

<div class="row">
<p>
    <a href="<?php echo U('/demodata/add/form_id/'.$form_one['id']);?>" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-plus"></span> 添加</a>
</p>
...
<table class="table table-hover">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td><a href="<?php echo U('/demodata/edit/form_id/'.$form_one['id'].'/id/'.$vo['id']);?>" target="_blank">编辑</a>&nbsp;&nbsp;<a href="<?php echo U('/demodata/view/form_id/'.$form_one['id'].'/id/'.$vo['id']);?>" target="_blank">查看</a></td>
