  ...
  <div class="navbar-inner">
    ...
    <div class="bs-header" id="content">
        <div class="container">
            ...
            <h1><img src="/Public/js/ueditor/formdesign/images/leipi_formdesign.png" width="64" />WEB表单设计器 <small>Ueditor
                    Formdesign Plugins4.1.x</small></h1>
            <p>
                感谢大家使用，如有任何意见或建议，请务必告知，<a href="#bs-footer">免责声明</a>。
                <p>
                    复制分享：<input type="text" value="大家都在用雷劈网WEB表单设计器，你去官网看看 http://formdesign.leipi.org/" style="width:80%"
                        onclick="this.select()" />
                </p>
                交流Q群：143263697
            </p>
...
<p>
 ...
 <div class="bs-footer" role="contentinfo" id="bs-footer">
    ...
    <script type="text/javascript" charset="utf-8" src="/Public/js/jquery-1.7.2.min.js?<?php echo ($_cjv); ?>"></script>
